...
LCREF = "AVHRR/data/MODIS_LCREF_v3/"
...
time_arr = np.load("../../data/time_arr.npy")[:-12].reshape(-1, 24)[IDX+19]
...
for i in tqdm(range(len(yearmonth_list))):
    ...
    lcref_ds.attrs = {"title": "Long-term Continuous REFlectance with MODIS Input (LCREF-MODIS)", 
    ...
    lcref_ds.to_netcdf(os.path.join(LCREF, "LCREF_MODIS_v3.2_{}.nc".format(yearmonth_list[i])))
